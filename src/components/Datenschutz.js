...
import PrivacySeal from '../assets/img/misc/dsg-seal-pp-de.png'
  ...
  return (
    <section className='datenschutz__container'>
      ...
      <div>
        ...
        <p className='datenschutz__text'>
          E-Mail-Adresse:{' '}
          <a href='mailto:schottenschulle@aol.com'>schottenschulle@aol.com</a>
        </p>
        <p className='datenschutz__text'>Telefon: 030-4811672</p>
        <p className='datenschutz__text'>
          Impressum:{' '}
          <a
            href='https://schottenschulle.de/impressum'
            target='_blank'
            rel='noreferrer'
          >
            https://schottenschulle.de/impressum
          </a>
        </p>
